...
angular.module('es6App').service('StorageService', StorageService);
angular.module('es6App').service('TodoService', TodoService);

angular.module('es6App').controller('TodoListCtrl', TodoListCtrl);
angular.module('es6App').controller('TodoListNewCtrl', TodoListNewCtrl);
